...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
 ...
 xmlns:UML_Standard_Profile='http://www.omg.org/spec/UML/20131001/StandardProfileL2'
...
Lecture MD 17.0.2
Version 2.1
Cette version de MD utilise les espaces de noms20131001
Le corps des contraintes des opérations est un sous-élément au lieu d'être un attribut
Cette version de lecture.xsl est architecturée par le contenu du modèle plutôt que par
les stéréotypes
--------------------------------------------------------------------------------------
        </xsl:message>
